...
class PersonServiceIntegrationSpec extends AnyWordSpec with Matchers with BeforeAndAfterAll with ScalaFutures {
  ...
  private val client = testKit.getGrpcClient(classOf[PersonService])
